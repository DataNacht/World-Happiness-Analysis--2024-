...
/*What was the level of happiness in Argentina last year?*/
SELECT gh.LifeLadder, gh.YearCalendar, gh.Country 
FROM GlobalHappiness gh
...
/* Which were the top five years with less happiness in Argentina?*/
SELECT gh.LifeLadder, gh.YearCalendar, gh.Country
FROM GlobalHappiness gh
WHERE gh.Country = 'Argentina'
...
/*When was the maximum level of happiness registered in Argentina?*/
SELECT gh.LifeLadder, gh.YearCalendar, gh.Country
FROM GlobalHappiness gh
WHERE gh.Country = 'Argentina'
ORDER BY gh.LifeLadder DESC
...
/*When was the minimum levels of happiness registered in Argentina?*/
SELECT gh.LifeLadder, gh.YearCalendar, gh.Country
FROM GlobalHappiness gh
WHERE gh.Country = 'Argentina'
ORDER BY gh.LifeLadder 
...
/*When was the lowest levels of positive effect registered in Argentina?*/
